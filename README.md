...
```
podman build -t quay.io/jnyilimbibi/devspaces-extended-udi:3.26 .
podman push quay.io/jnyilimbibi/devspaces-extended-udi:3.26
```
...
components:
  - name: tools
    container:
      image: quay.io/jnyilimbibi/devspaces-extended-udi:3.26
      memoryRequest: 2Gi
      memoryLimit: 6Gi
      cpuLimit: 4000m
      cpuRequest: 1000m
