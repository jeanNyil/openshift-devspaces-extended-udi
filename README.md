...
```
podman build -t quay.io/jnyilimbibi/devspaces-extended-udi:3.15 .
podman push quay.io/jnyilimbibi/devspaces-extended-udi:3.15
```
...
components:
  - name: tools
    container:
      image: quay.io/jnyilimbibi/devspaces-extended-udi:3.15
      memoryRequest: 2Gi
      memoryLimit: 6Gi
      cpuLimit: 4000m
      cpuRequest: 1000m
